...
class Base
{
    const KEY = 'sdg634fghgu5654rtghfghgfy4575htg'; //支付秘钥需要更改成自己的
    const APPID = 'wx3d751ea7a2f7c064'; //APPID需要更改为自己的
    ...
    const NOTIFY = 'http://peng.jinxiaofei.xyz/notify';   //支付通知地址需要更改成你自己服务器的地址
    ...
    public function unifiedorder($params){
        ...
        file_put_contents('./pay.log' , $arr , FILE_APPEND);
