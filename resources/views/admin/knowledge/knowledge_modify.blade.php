...
<div class="x-body">
    <form action="" method="post" class="layui-form layui-form-pane">
        <input type="hidden" value="{{$knowledge -> k_id}}" name="k_id">
        @csrf
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="k_title" name="k_title" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{$knowledge -> k_title}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="k_content" id="" cols="50" rows="30" required="" lay-verify="required"
                          autocomplete="off" class="layui-input" >{{$knowledge -> k_content}}</textarea>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="m_money" name="k_from" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{$knowledge -> k_from}}">
            </div>
        </div>
